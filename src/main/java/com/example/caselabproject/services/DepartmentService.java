...
public interface DepartmentService {
     ...
     * @throws com.example.caselabproject.exceptions.department.DepartmentCreateException        если произошла ошибка при создании департамента.
     ...
     * Если департамент не найден, будет выброшено исключение {@link com.example.caselabproject.exceptions.department.DepartmentNotFoundException}.
     * Если статус записи департамента уже является "DELETED", будет выброшено исключение {@link com.example.caselabproject.exceptions.department.DepartmentStatusException}.
     * </p>
     *
     * @param departmentId ID департамента, статус записи которого нужно удалить.
     * @throws com.example.caselabproject.exceptions.department.DepartmentNotFoundException если департамент с указанным ID не найден.
     * @throws com.example.caselabproject.exceptions.department.DepartmentStatusException   если статус записи департамента уже является "DELETED".
     * @author Khodov Nikita
     */
    @Transactional
     ...
     * Если департамент не найден, будет выброшено исключение {@link com.example.caselabproject.exceptions.department.DepartmentNotFoundException}.
     * Если статус записи департамента уже является "ACTIVE", будет выброшено исключение {@link com.example.caselabproject.exceptions.department.DepartmentStatusException}.
     * </p>
     *
     * @param departmentId ID департамента, статус записи которого нужно восстановить.
     * @throws com.example.caselabproject.exceptions.department.DepartmentNotFoundException если департамент с указанным ID не найден.
     * @throws com.example.caselabproject.exceptions.department.DepartmentStatusException   если статус записи департамента уже является "ACTIVE".
     * @author Khodov Nikita
     */
    @Transactional
     ...
     * Если департамент с заданным ID не найден, будет выброшено исключение {@link com.example.caselabproject.exceptions.department.DepartmentNotFoundException}.
     * </p>
     *
